<div class="tab-pane active" id="track">
	<div class="row item-list item-list-by m-b">
		<div class="col-xs-12">
			<div class="item r" data-id="item-7" data-src="http://e9ddc311.ngrok.io/stream">
				...
				<div class="item-info">
					...
					<div class="item-except visible-list text-sm text-muted h-2x m-t-sm">Quid ad utilitatem tantae pecuniae? Utram tandem linguam nescio? Sed hoc sane concedamus.</div>
		...
		<!-- <div class="col-xs-12">
			<div class="item r" data-id="item-11" data-src="<?php echo site_url(); ?>assets/api.soundcloud.com/tracks/218060449/streamd9be.html?client_id=a10d44d431ad52868f1bce6d36f5234c">
				<div class="item-media">
				...
				<div class="item-info">
					...
					<div class="item-except visible-list text-sm text-muted h-2x m-t-sm">Saepe faciamus. Quid ad utilitatem tantae pecuniae? Utram tandem linguam nescio? Sed hoc sane concedamus.</div>
					<div class="item-action visible-list m-t-sm">
						<a href="#" class="btn btn-xs white">Edit</a> 
						<a href="#" class="btn btn-xs white" data-toggle="modal" data-target="#delete-modal">Delete</a>
					</div>
		...
		<div class="col-xs-12">
			<div class="item r" data-id="item-10" data-src="<?php echo site_url(); ?>assets/api.soundcloud.com/tracks/237514750/streamd9be.html?client_id=a10d44d431ad52868f1bce6d36f5234c">
				<div class="item-media">
				...
				<div class="item-info">
					...
					<div class="item-except visible-list text-sm text-muted h-2x m-t-sm">Litatem tantae pecuniae? Utram tandem linguam nescio? Sed hoc sane concedamus.</div>
					<div class="item-action visible-list m-t-sm">
						<a href="#" class="btn btn-xs white">Edit</a>
						<a href="#" class="btn btn-xs white" data-toggle="modal" data-target="#delete-modal">Delete</a>
					</div>
